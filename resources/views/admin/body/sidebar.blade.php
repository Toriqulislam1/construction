    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('project-add')}}"><i class="ti-more"></i>Create</a></li>
            <li><a href="{{ route('project-manage')}}"><i class="ti-more"></i> Manage Project </a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          <a href="#">
            <i data-feather="mail"></i> <span>Contact Us request</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
